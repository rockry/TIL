...
# 추가
## 기획부터 배포까지 전체 Cycle을 수행한 경험이 있나요?
성향상 기획이나 UX에 참여하고 피드백을 주는 것을 좋아합니다. MC있을때 수행했던 WPS-NFC, 가전에서의 모든 신규 모듈들을 구현할때도 기획단계부터 의견제시를 하고 나야가야할 방향이나 현실적으로 가능한 부분 등을 같이 고민하려고 했습니다. 이후 양산 프로세스까지 전체 경험을 했고, 실제 마켓에는 제가 배포하지는 않았습니다.
배포경험을 해보고 싶어서 개인프로젝트로 ionic2 어플리케이션을 만들어서 PlayStore에 배포한 경험이 있습니다.

## 성공사례 한가지만 이야기해주세요.
군대에서 운전병으로 근무했었는데요. 충남 전역을 다녀야하는 업무이다보니 신병들에게 위험한 길도 많고 잘 모르는 길도 많았습니다.
네비게이션을 구매하기엔 예산이 없었기 때문에, 미리 여정을 숙지하고 갈 수 있도록 플래쉬로 가상 네비게이션을 만들었습니다.
충남 전 부대의 지리를 표시하고 직접 답사하며 위험지역이나 숙지할 곳 사진을 찍고 TTS까지 넣어서 각 지역별 애니메이션처럼 볼 수 있도록 제작했습니다.
부대원들의 안전 확보와 지리 숙지에 이바지해서 사단장 표장까지 받았었습니다.

## 업무 외적으로 진행한 프로젝트가 있나요?
angularjs가 너무 old한 기술이라 신규 기술을 경험해보고 싶었고, 실제 배포경험도 해보고 싶어서 ionic2로 어플리케이션을 만들었습니다.
몰입타이머라고 해서 시간관리방법론인 25분 몰입 5분 휴식을 4cycle돌고 30분 휴식하는 패턴으로 업무나 공부를 능률적으로 할 수 있도록 알려주는 타이머 입니다.

## 누가 시켜서 한 업무 이외에 자발적으로 업무를 만들어서 한 경험이 있나요?
MC에서는 에이징테스트 앱, Wi-Fi Packet Monitor 앱 등 연구원들에게 도움이 될만한 앱을 개발한 경험이 있고, 가전에서는 앱 진입속도가 너무 느려서 개인하고싶은 마음에 속도개선 Task를 진행한 적도 있습니다. 신규모듈 진행이나 홈로봇 앱 개발도 먼저 지원해서 투입되었습니다.
그 외에 Wi-Fi업무때에는 Wi-Fi 기술을 더 깊게 알기위해서 Linux System 등을 공부하기도 했었고, Wi-Fi Aliance 국내 컨퍼런스 등에도 꾸준히 참여하려고 하였습니다.
가전에서 front-end/back-end 개념을 접하고 나서는 서버와의 통신과정을 알고 싶어서 nodejs를 공부하기도 했습니다.

## 관심있는 최신 트랜드
RxJava, Kotlin, lambda, Dagger 등의 Android 최신 기술들. MVC/MVP/MVVM등의 아키텍쳐 및 개발방법론.
Backend의 AWS Lambda등도 관심을 가지고 싶은데, 우선 Android 개발부터 실력을 쌓고나서 다른 부분도 접해보고 싶다.
front-end 기술의 정점이라고 생각하는 unity에도 관심이 있어서 오재홍 책임이 진행했던 unity simulator 세미나도 참석했습니다.
그리고 frontend/backend를 막론하고 오픈소스 라이브러리가 대세인 것 같습니다.
이런 라이브러리들에 익숙해지고 그냥 가져다 쓰는게 아니라 기술적으로 이해하고자 하는 마음이구요.
여러 기술 적용에 능숙해져서 어떤 플랫폼에서도 적응할 수 있는 풀스택개발자가 되는게 1차목표구요.
풀스택개발자가 되면 전체적인 관점에서 우리가 하고자하는 서비스를 어떻게 효율적으로 어떤 구조로 잘 만들어야할지 대안을 제시할 수 있는 사람이 되고 싶습니다.
